...
class ActivityDataset(utils.Dataset):
    ...
    def load_activity(self, dataset_json_path):
        ...
        # Add classes:
        self.classes_names = ["Sneakers", "Hat"]
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for idx, (mask_path, mask_class) in enumerate(self.json_data[info["id"]].items()):
...
def train(model):
    ...
    dataset_train.load_activity("dataset/train/Trial.json")
    dataset_train.prepare()

    # Validation dataset
    #dataset_val = ActivityDataset()
    #dataset_val.load_activity(args.dataset, "val")
    #dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    weights_path = "/Users/KarimAsh/Desktop/Mask_RCNN-master/weights/mask_rcnn_coco.h5"
